...
/*---------------------------------------*/
/* Gazebo plugin for attaching two links */
/*---------------------------------------*/
namespace gazebo
{
  /*---------------------------------------*/
  ...
  void GazeboRosLinkAttacher::Load(physics::WorldPtr _world, sdf::ElementPtr /*_sdf*/)
  {
    ...
    /*-----------------------------------------*/
    /* Get Gazebo world and physics properties */
    /*-----------------------------------------*/
    this->world = _world;
  ...
  /*--------------------------*/
  bool GazeboRosLinkAttacher::attach_callback(ur_robot_gazebo::Attach::Request  &req,
                                              ur_robot_gazebo::Attach::Response &res)
  {
  ...
  /*--------------------------*/
  bool GazeboRosLinkAttacher::detach_callback(ur_robot_gazebo::Attach::Request  &req,
                                              ur_robot_gazebo::Attach::Response &res){
